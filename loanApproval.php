...
<?php
$resultSet = Database::search("SELECT loan.loan_order_id, loan.product_name, loan.loan_amount, order_status.status AS status_name
FROM loan
...
<head>
    ...
    <style>
        .nav-bar-shadow {
            box-shadow: 0px 0px 10px 0px rgb(0, 9, 58);
        }
    </style>
</head>

<body class="bg-light f-size">
    <div class="container-fluid nav-bar-shadow">
        <?php include "navBar.php"; ?>
    </div>

    <div class="container mt-4">
        <div class="mt-4 mb-2 fs-3">Pending reviews</div>
            ...
            <tbody id="tableBody">
                ...
                ?>
                    <tr>
                        ...
                        <td class="center-vertical"><button type="button" class="btn btn-sm btn-warning" style="font-size: 12px;">Approve</button></td>
                    </tr>
                <?php
                }
                ?>
